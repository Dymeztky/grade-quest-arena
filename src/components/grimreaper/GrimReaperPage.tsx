      ...
      <div className="glass-card p-6 bg-gradient-to-br from-grim/20 to-card border-grim/30">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Taruhan nilai, yang kalah kehilangan item!</p>
          </div>
        </div>
        ...
        <div className="mt-4 p-3 rounded-lg bg-destructive/10 border border-destructive/30 flex items-start gap-2">
          ...
          <p className="text-sm text-destructive">
            <strong>Peringatan:</strong> Item yang dipertaruhkan akan hilang jika kalah. Pilih dengan bijak!
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredChallenges.map((challenge) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">menantang di {challenge.subject}</p>
                </div>
              </div>
            ...
            <div className="bg-secondary/50 rounded-lg p-4 mb-4">
              <p className="text-sm text-muted-foreground mb-1">Item Taruhan</p>
              <div className="flex items-center justify-between">
                <p className="font-display font-bold text-lg">{challenge.stakeItem}</p>
                <span className="text-gold font-display font-bold">≈ {challenge.stakeValue} Koin</span>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                ...
                {challenge.participants && (
                  <span className="flex items-center gap-1">
                    ...
                    {challenge.participants} tertarik
                  </span>
                )}
              </div>
        ...
        {filteredChallenges.length === 0 && (
          <div className="glass-card p-12 text-center">
            ...
            <p className="text-muted-foreground">Belum ada tantangan di sini</p>
          </div>
        )}
      </div>
    </div>
