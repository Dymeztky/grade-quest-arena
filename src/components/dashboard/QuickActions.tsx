  ...
  const actions: QuickActionProps[] = [
    {
      icon: ShoppingBag,
      label: "Shop",
      description: "Beli item & kostum baru",
      color: "gold",
      badge: "3 Baru",
    ...
    },
    {
      icon: Trophy,
      label: "Leaderboard",
      description: "Lihat ranking angkatanmu",
      color: "primary",
    ...
    },
    {
      icon: Skull,
      label: "Grim Reaper",
      description: "Taruhan nilai, menang item!",
      color: "grim",
      badge: "2 Live",
    ...
    },
    {
      icon: Users,
      label: "Teman",
      description: "Lihat progress temanmu",
      color: "success",
    ...
    },
    {
      icon: FileText,
      label: "Catatan",
      description: "Upload & akses catatanmu",
      color: "primary",
    ...
    },
    {
      icon: Target,
      label: "Goals",
      description: "Atur target nilaimu",
      color: "gold",
